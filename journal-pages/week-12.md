...
### Final Emotional Awareness Tool

![alt text](../assets/week-12/Screenshot%202026-05-30%20at%203.56.10 PM.png)

The final version of the Emotional Awareness Tool allows users to record emotions, identify emotional patterns, analyse triggers, and reflect on emotional experiences through long-term emotional data tracking.

---

## Interactive Prototype

The final prototype can be explored through the interactive p5.js sketch below.
...
This project helped me understand how data visualisation can support emotional awareness and self-reflection. Throughout the semester, the project evolved from a simple emotion recording system into a more complete emotional awareness tool.

One of the most important lessons I learned was that data visualisation does not always need to solve problems directly. Instead, it can help people recognise patterns, understand behaviours, and reflect on personal experiences.

By combining emotional records, triggers, reflection notes, and trend analysis, the final prototype demonstrates how personal data can be transformed into meaningful insights. The project shows how visualisation can make emotional experiences easier to understand and encourage greater awareness of emotional wellbeing.